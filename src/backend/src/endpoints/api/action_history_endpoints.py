...
def register_action_history_endpoints(app: FastAPI, data_access: DataAccess):
    # ---------------------------- GET ----------------------------
    @app.get("/api/action_history", response_model=List[GetActionHistory], tags=["Action History"])
    ...
    @app.get("/api/action_history/{action_history_id}", response_model=GetActionHistory, tags=["Action History"])
    ...
    # ---------------------------- ADD ----------------------------
    @app.post("/api/action_history/manual_add/{website_id}", response_model=GetActionHistory, tags=["Action History"])
